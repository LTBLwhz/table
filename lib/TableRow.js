...
function (_React$Component) {
  ...
  _createClass(TableRow, [{
    ...
    value: function render() {
      ...
      var hasLeftFixed = columns.find(function (column) {
        return column.fixed === 'left';
      });
      var hasRightFixed = columns.find(function (column) {
      ...
      if (!hasLeftFixed && hasRightFixed) {
        var ml = columns.filter(function (column) {
          return column.fixed === 'right';
        }).reduce(function (t, c) {
          t += c.width;
          return t;
      ...
      return _react.default.createElement(BodyRow, Object.assign({
        ref: function ref(r) {
          return _this2.TrRef = r;
        }
      }, rowProps, {
